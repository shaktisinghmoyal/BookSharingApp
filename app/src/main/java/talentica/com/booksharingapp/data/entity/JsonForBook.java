...
public class JsonForBook {
    ...
    public static JSONObject getJsonObjectOfBook(Book book) throws JSONException, IllegalAccessException{
    ...
    public static JSONObject getJsonObjectOfBook(int bookId) throws JSONException, IllegalAccessException{
       ...
       //content provider se lena
        return  makeJsonObjectOfBook(new Book());
    }

    private static JSONObject makeJsonObjectOfBook(Book book) throws JSONException, IllegalAccessException{
